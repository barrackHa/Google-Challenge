...
Commander Lambda is preparing for her debut on the galactic stage - 
but in order to make a grand entrance, 
she needs a grand staircase! As her personal assistant, 
...
(for example, 3 little pink bricks, or 5 blue lace bricks). 
Commander Lambda wants to know how many different types of staircases 
can be built with each amount of bricks, 
...
A step's height is classified as the total amount of bricks that make up 
that step.
For example, when N = 3, 
you have only 1 choice of how to build the staircase, 
with the first step having a height of 2 and the second step having a 
...
But when N = 5, 
there are two ways you can build a staircase from the given bricks. 
...
exactly n bricks. 
n will always be at least 3 (so you can have a staircase at all), 
...
def cases(h,l,t):
    ...
    if l<h:
        return 0
    t[h][l] = cases(h+1,l-h,t) + cases(h+1,l,t)
